...
export default function NavBar() {
  ...
  const mobileLinkBaseClasses: string =
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex gap-8 items-center">
            ...
            <Link
              to="/about"
              className={`${linkBaseClasses} ${
                isActive("/about") ? "text-blue-400" : "text-slate-300"
              }`}
            >
              Sobre mí
              <span
            ...
            <Link
              to="/proyectos"
              className={`${linkBaseClasses} ${
                isActive("/proyectos") ? "text-blue-400" : "text-slate-300"
              }`}
            >
              Proyectos
              <span
                className={`absolute -bottom-1 left-0 h-0.5 bg-blue-400 transition-all duration-300 ${
                  isActive("/proyectos") ? "w-full" : "w-0 group-hover:w-full"
                }`}
              ></span>
            </Link>
            ...
            <Link
              to="/cv"
              className={`${linkBaseClasses} ${
                isActive("/cv") ? "text-blue-400" : "text-slate-300"
              }`}
            >
              CV
              <span
                className={`absolute -bottom-1 left-0 h-0.5 bg-blue-400 transition-all duration-300 ${
                  isActive("/cv") ? "w-full" : "w-0 group-hover:w-full"
                }`}
              ></span>
            </Link>
